...
class HouseholdMemberDemographics(models.Model):
	household_member = models.ForeignKey(HouseholdMember)
	birthdate = models.DateField(verbose_name=_('Birth Date'), help_text=_('')) #no later than 100 years ago
	gender = models.CharField(max_length=20, choices=GENDER, verbose_name=_('Gender'), help_text=_(''))
	...
	disabled = models.BooleanField(verbose_name=_(''), help_text=_('Disabled'))
	veteran = models.BooleanField(verbose_name=_(''), help_text=_('Veteran'))
